      ...
      <main className="flex flex-col lg:flex-row items-center justify-between px-10 py-20 gap-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-xl">
            LifeOps helps you manage tasks, track habits, automate routines, and stay on top of your goals — all in one clean, powerful app.
          </p>
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-center gap-2">
              <CheckCircle className="text-green-500 w-5 h-5" /> Task & Habit Tracking
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle className="text-green-500 w-5 h-5" /> Email + Calendar Integration
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle className="text-green-500 w-5 h-5" /> Daily & Weekly Reviews
            </li>
          </ul>
          <div className="pt-4">
            <Link to="/register">
              <Button className="text-lg px-6 py-3">Start Your Journey</Button>
            </Link>
          </div>
        </motion.div>
